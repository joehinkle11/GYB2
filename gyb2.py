...
# Modified to support new multiple Swift files from one GYB by Joe Hinkle
# just place:
#     // new gyb file FILENAME
# where you want file break. If you put none in, gyb exhibits normal behavior
